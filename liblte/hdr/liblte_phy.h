...
// Structs
// Functions
float liblte_phy_prb_monitor(LIBLTE_PHY_STRUCT              *phy_struct,
			     LIBLTE_PHY_SUBFRAME_STRUCT     *subframe,
			     uint32                          N_id_cell,
			     uint8                           N_ant);
...
/*********************************************************************
    Name: liblte_phy_dl_find_prb_utilization

    Description: Finds downlink PRB utilization by looking at the time domain signal strength
...
// Structs
// Functions
float liblte_phy_dl_spectrum_monitor(LIBLTE_PHY_STRUCT               *phy_struct,
                                                                   float                           *i_samps,
                                                                   float                           *q_samps,
                                                                   uint32                           N_slots);
...
/*********************************************************************
    Name: liblte_phy_get_dl_subframe_only
...
// Structs
// Functions
LIBLTE_ERROR_ENUM liblte_phy_get_dl_subframe_only(LIBLTE_PHY_STRUCT          *phy_struct,
						  float                      *i_samps,
						  float                      *q_samps,
						  uint32                      frame_start_idx,
						  uint8                       subfr_num,
...
// Structs
// Functions
void liblte_phy_get_dl_resync(LIBLTE_PHY_STRUCT          *phy_struct,
                                                    float                      *i_samps,
                                                    float                      *q_samps,
